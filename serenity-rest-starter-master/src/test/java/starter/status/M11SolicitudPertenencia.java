...
import static starter.WebServiceEndPoints.M11;

public class M11SolicitudPertenencia {

    public AppStatus currentStatus(String Params) {
    	
    	System.out.println(M11.getUrl() + "/" + Params);
        int statusCode = RestAssured.get(M11.getUrl() + "/" + Params).statusCode();
...
//    	return SerenityRest.get(M1.getUrl());
    ...
    public void readStatusMessage(String Params) {
        SerenityRest.get(M11.getUrl() + "/" + Params);
    }
}
