...
import static starter.WebServiceEndPoints.M12;

public class M12Casos {

    public AppStatus currentStatus(String Params) {
    	
    	System.out.println(M12.getUrl() + "/" + Params);
        int statusCode = RestAssured.get(M12.getUrl() + "/" + Params).statusCode();
...
//    	return SerenityRest.get(M1.getUrl());
    ...
    public void readStatusMessage(String Params) {
        SerenityRest.get(M12.getUrl() + "/" + Params);
    }
}
