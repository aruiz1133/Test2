...
public class M1CoberturaClientesStepDefinitions {
	
	
	
	
    @Steps
    M1CoberturaClientes theApplication;
    String trade;
    String Params;
    
    @Steps
   M1Response theTradeDetails;
    
    
    	
	@Given("Yo Llamo  GET {int}:")
...
//			Map<String, String> linkedHashMap = new LinkedHashMap<String, String>();
			...
			String lineN = Files.readAllLines(Paths.get("C:\\DATA_WebService\\M1.csv")).get(global);
			parts = lineN.split("\\;");
			partsn = parts;
