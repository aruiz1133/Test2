...
public class M11SolicitudPertenenciaStepDefinitions {
	
	
	
	
    @Steps
    M11SolicitudPertenencia theApplication;
    String trade;
    String Params;
    
    @Steps
    M11Response theTradeDetails;
    
    
    	
    @Given("Busco el archivo Get {int}:")
    public void busco_el_archivo_Get(Integer int1)throws IOException {
...
//			Map<String, String> linkedHashMap = new LinkedHashMap<String, String>();
			...
			String lineN = Files.readAllLines(Paths.get("C:\\DATA_WebService\\M11.csv")).get(global);
			parts = lineN.split("\\;");
			partsn = parts;
...
//			}
    ...
    @When("Dividimos Campos")
    public void dividimos_Campos() {
...
//	    throw new cucumber.api.PendingException();
    ...
    @Then("Recibimos estos Campos:")
    public void recibimos_estos_Campos(io.cucumber.datatable.DataTable dataTable) {
