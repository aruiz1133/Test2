...
import starter.status.M15Autorizacion;
...
import starter.trades.M15Response;
...
public class M15AutorizacionesStepDefinitions {
	
	
	
	
    @Steps
    M15Autorizacion theApplication;
    String trade;
    String Params;
    
    @Steps
    M15Response theTradeDetails;
    
    
    	
    @Given("Analizamos archivo Get {int}:")
    public void Analizamos_archivo_Get(Integer int1)throws IOException {
...
//			Map<String, String> linkedHashMap = new LinkedHashMap<String, String>();
			...
			String lineN = Files.readAllLines(Paths.get("C:\\DATA_WebService\\M15.csv")).get(global);
			parts = lineN.split("\\;");
			partsn = parts;
...
//	    throw new cucumber.api.PendingException();
    ...
    public void obtememos_Campos(io.cucumber.datatable.DataTable dataTable) {
