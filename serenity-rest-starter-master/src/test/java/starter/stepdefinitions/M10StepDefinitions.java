...
public class M10StepDefinitions {


    @Steps
    RecordNewM10 recordNewM10;
...
//	public void recorrremos_el_archivo(Integer int1) throws IOException {}
	...
	public void validamos_el_archivo(Integer int1) throws IOException {
		...
		String line0 = Files.readAllLines(Paths.get("C:\\DATA_WebService\\M10.csv")).get(0);
		parts = line0.split("\\;");
		parts0 = parts;
		...
		String lineN = Files.readAllLines(Paths.get("C:\\DATA_WebService\\M10.csv")).get(global);
		parts = lineN.split("\\;");
		partsn = parts;
		 ...
		 * 
		 */
		trade = MergeFrom.template("templates/M10Imagenes.json")
				.withDefaultValuesFrom(FieldValues.in("templates/standar-M10SoporteImagenes.properties"))
...
//	    throw new cucumber.api.PendingException();
		RecordNewM10.withDetails(trade);
	}
//	
